export class PortfolioManager {
  constructor() { this.positions = new Map(); this.closedPnl = 0; }
  applyFill(fill) {
  ...
  snapshot() { return { realizedPnl: Number(this.closedPnl.toFixed(2)), openPositions: this.positions.size, exposure: this.exposure(), positions: [...this.positions.values()] }; }
}
